...
p<-deprem_senaryo%>%ggplot(aes(x=ilce_adi, y=cok_agir_hasarli_bina_sayisi))+geom_point()
p
```

İlce bazinda hanelerdeki riskli yapi durumu hakkindaki bireysel ongorulerin oranlari:
...
İlce bazinda hanelerdeki kentsel donusum fikri hakkindaki bireysel ongorulerinin oranlari:
